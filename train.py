...
def get_args():
    ...
    p.add_argument('--fine_tune_lr', type=float, default=0.1)
...
def _eval_global_k_image(nets_this: Dict[int, torch.nn.Module], args, net_dataidx_map, X_train, y_train, X_test, y_test,
    ...
    for net_id, net in nets_this.items():
        ...
        clf = LogisticRegression(penalty='l2', random_state=0, C=1.0, solver='lbfgs', max_iter=200, multi_class='multinomial')
